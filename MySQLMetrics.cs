...
//                 command.ExecuteNonQuery();
                ...
                command.ExecuteNonQuery();
                command.CommandText = "CREATE TABLE IF NOT EXISTS azmy_metrics_collector.azmy_global_status (metric_name VARCHAR(64) NOT NULL UNIQUE, origin_metric_value VARCHAR(1024));";
                command.ExecuteNonQuery();
